...
#
# Testscript to test serominer multiple pools/hosts/syntaxes
# Put this script in the bin directory of serominer and start running
#
...
# export some vars as "./serominer" could be still a wrapper script
...
for pool in $POOLS; do
    ...
    echo "./serominer -v 1 --exit --report-hashrate -P $pool $@"
    echo "./serominer -v 1 --exit --report-hashrate -P $pool $@" > log.txt
    ./serominer -v 1 --exit --report-hashrate -P $pool $@ >> log.txt 2>&1 &
    pid=$!
    #echo "PID=$pid"
