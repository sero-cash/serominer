...
__device__ __constant__ const uint32_t keccakf_rndc[24] = {0x00000001, 0x00008082, 0x0000808a, 0x80008000, 0x0000808b,
    0x80000001, 0x80008081, 0x00008009, 0x0000008a, 0x00000088, 0x80008009, 0x8000000a, 0x8000808b, 0x0000008b,
    0x00008089, 0x00008003, 0x00008002, 0x00000080, 0x0000800a, 0x8000000a, 0x80008081, 0x00008080, 0x80000001,
    0x80008008};
...
__global__ void progpow_search(uint64_t start_nonce, const hash32_t* header, const uint64_t* target, const dag_t* g_dag,
    volatile search_results* g_output, bool hack_false)
{
